...
public class OneToOneTest {
    ...
    void test1() {
        ...
        food.setPrice(15000);
        food.setUser(user); // 외래 키(연관 관계) 설정 + 여기서 food의 user_id로 1을 넣어줌
    ...
    @DisplayName("1대1 양방향 테스트 : 외래 키 저장 실패") // 주인이 아닌 곳에 값 저장
    void test2() {
        Food food = new Food();
        food.setName("고구마 피자");
        food.setPrice(30000);
    ...
    @Test
    @Rollback(value = false)
    @DisplayName("1대1 양방향 테스트 : 외래 키 저장 실패 -> 성공") // 주인이 아닌 곳에 값 저장
    void test3() {
        Food food = new Food();
        food.setName("고구마 피자");
        food.setPrice(30000);
